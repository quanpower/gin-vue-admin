  ...
  data () {
    return {
      ...
      columns: [
        ...
        {name: 'test_parameter', align: 'left', label: '参数', field: 'test_parameter', sortable: true},
        {name: 'data', align: 'left', label: '测试数据', field: 'data'},
        {name: 'result', align: 'left', label: '测试结果', field: 'result'},
        {name: 'bypass', align: 'left', label: '人工放行', field: 'bypass'},
        {name: 'result_desp', align: 'left', label: '测试描述', field: 'result_desp'},
      ],
