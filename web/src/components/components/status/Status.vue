      ...
      <template v-slot:body="props">
        <q-tr >
          ...
          <q-td key="op10" >
            <div class="row">
              <div class="col">
                <Indicator :colors="props.row.op10.left"> </Indicator>
              </div>
              <div class="col">
                <Indicator :colors="props.row.op10.right"> </Indicator>
              </div>
            </div>
          </q-td>
          <q-td key="op20" >
            ...
            <div class="row">
              <div class="col">
                <Indicator :colors="props.row.op20.left"> </Indicator>
              </div>
              <div class="col">
                <Indicator :colors="props.row.op20.right"> </Indicator>
              </div>
            </div>
          ...
          <q-td key="op30" >
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op30.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op30.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op40" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op40.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op40.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op50" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op50.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op50.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op60" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op60.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op60.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op70" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op70.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op70.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op80" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op80.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op80.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op90" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op90.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op90.right"> </Indicator>
                    </div>
                  </div>
          ...
          <q-td key="op100" >
                  ...
                  <div class="row">
                    <div class="col">
                      <Indicator :colors="props.row.op100.left"> </Indicator>
                    </div>
                    <div class="col">
                      <Indicator :colors="props.row.op100.right"> </Indicator>
                    </div>
                  </div>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'op10', label: 'OP10', field: 'op10', align: 'center',sortable: true },
        { name: 'op20', label: 'OP20', field: 'op20', align: 'center',sortable: true },
