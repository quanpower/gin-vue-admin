...
func (m *menu) Initialize() error {
	entities := []system.SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: true, ParentId: "0", Path: "about", Name: "about", Component: "view/about/index.vue", Sort: 7, Meta: system.Meta{Title: "关于我们", Icon: "info"}},
		...
		{MenuLevel: 0, Hidden: true, ParentId: "0", Path: "http://www.shlean.com", Name: "http://www.shlean.com", Component: "/", Sort: 0, Meta: system.Meta{Title: "官方网站", Icon: "s-home"}},
